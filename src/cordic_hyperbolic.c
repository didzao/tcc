...
/*
 * MODO DE VETORIZACAO HIPERBOLICA (Hyperbolic Vectoring Mode):
 * 
 * Objetivo: Forcar a coordenada 'y' a convergir para zero (y -> 0).
 * 
 * Propriedades:
 * - O acumulador 'z' converge para: z_0 + atanh(y_0 / x_0)
 * - A coordenada 'x' preserva a norma hiperbolica: (1/K) * sqrt(x_0^2 - y_0^2)
 * 
 * Nota de convergencia: As iteracoes i = 4 e i = 13 sao repetidas
 * para satisfazer o criterio de convergencia do CORDIC hiperbolico.
 */
